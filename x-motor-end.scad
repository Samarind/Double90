...
//                 // // Endstop holder
//                 // translate([3 * wall / 2, clamp_width + Z_bearing_holder_width / 2 - 1.5 * wall, microswitch_length()])
//                 //     cube([3 * wall, wall, 2 * microswitch_length()], center = true);
