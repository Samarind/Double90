    ...
    difference() {
        ...
        for(end = [idler_end, motor_end])
            translate([end, gantry_Y, height - base_clearance - bar_clamp_depth / 2])
                rotate([0, 90, 90])
                    bar_clamp_holes(Z_smooth_rod_diameter, false)
                        frame_screw_hole();
        ...
        // Wiring holes
        //
        translate([idler_end - bar_rail_offset(Z_smooth_rod_diameter) + 0.5 * bar_clamp_tab,
        ...
        translate([max(motor_end + bar_rail_offset(Z_smooth_rod_diameter),
        ...
        translate([idler_end - bar_rail_offset(Z_smooth_rod_diameter),
